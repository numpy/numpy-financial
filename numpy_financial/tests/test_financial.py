...
class TestFinancial(object):
    ...
    def test_rate_nan(self, number_type):
        ...
        """
        rate = numpy.rate(number_type(12.0), number_type('400.0'), number_type('10000.0'), number_type(0))
        assert_equal(numpy.nan, float(rate))
        rate = numpy.rate(number_type(12.0), number_type('400.0'), number_type('10000.0'), number_type(5000))
        assert_equal(numpy.nan, float(rate))

        # begin
        rate = numpy.rate(number_type(12.0), number_type('400.0'), number_type('10000.0'), number_type(20000), 1)
        assert_equal(numpy.nan, float(rate))
        rate = numpy.rate(number_type(12.0), number_type('400.0'), number_type('10000.0'), number_type(20000), 'begin')
        assert_equal(numpy.nan, float(rate))

        # end
        rate = numpy.rate(number_type(12.0), number_type('400.0'), number_type('10000.0'), number_type(0))
        assert_equal(numpy.nan, float(rate))
        rate = numpy.rate(number_type(12.0), number_type('400.0'), number_type('10000.0'), number_type(0), 'end')
        assert_equal(numpy.nan, float(rate))

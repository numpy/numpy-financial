...
def mirr(values, finance_rate, reinvest_rate, *, raise_exceptions=False):
    ...
    .. math::
        ...
        MIRR = \\left( \\frac{{FV_{positive}}}{{PV_{negative}}} \\right)^{\\frac{{1}}{{n-1}}} * (1+r) - 1
    ...
    >>> npf.mirr([-100, 50, -60, 70], 0.1, 0.12)
    -0.03909366594356467
    ...
    >>> npf.mirr([100, 50, 60, 70], 0.1, 0.12, raise_exceptions=True)
    NoRealSolutionError: No real solution exists for MIRR since all cashflows are of the same sign.
